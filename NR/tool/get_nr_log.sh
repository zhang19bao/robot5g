...
core_cfg='192.169.4.10,root/5gc-1.7-e500,core'
cu_cfg='192.169.4.20,/root/radisys-cu-1.7-e500/bin,cu'    #cu vm ip and path
du_cfg='192.169.4.30,cd /root/5gc-1.7-e500,du'    #du vm ip and path
tcpdumpList=($cu_cfg $du_cfg core_cfg)    #if cu and du in two vm; there are will be two cfg in tcpdumplist
