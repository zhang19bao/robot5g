*** Settings ***
Documentation     multi ue dl and ul udp simultaneous with tti=8:1
...
${USERNAME}       root
${PASSWORD}       123456
${du_config_path}    /root/gNB/radisys-1.7/radisys-du-1.7/config
${default_DL_tti}    1    #SCH_DL_UE_PER_TTI
${new_DL_tti}     8    #SCH_DL_UE_PER_TTI
${default_UL_tti}    1    #SCH_UL_UE_PER_TTI
${new_UL_tti}     1    #SCH_UL_UE_PER_TTI
${target_dl_tput}    1M
${target_ul_tput}    1M
