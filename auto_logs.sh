...
tcpdumpList=($smf $amf $cu0 $cu1 $cu2 $du0 $du1 $du2 $ue1)
#tcpdumpList=( $server $smf $amf $cu0 $cu1 $cu2 $cu3 $du0 $du1 $du2 $du3 $ue1 $ue2 $ue3 $uec1 $uec2 )
###tcpdump collect list

###syslog collect list
template="ip,type,log_path,log_files_num"
cu1s="192.169.4.20,cu,/root/radisys-cu-1.7-e500/bin,10"
du1s="192.169.4.30,du,/root/radisys-du-1.7-E500/bin,10"
